...
SPAM = [
    ...
    "Требуется человек для уборки после ремонта в квартирах. По 6000 день",
    "Ищем 2 курьеров, оплата ежедневно, 3500 за смену",
    "Нужны работники на склад, 15к в неделю",
]
HAM = [
    ...
    "Нужна помощь с ремонтом, посоветуйте мастера",
    "Ремонт у меня занял 300 дней и кучу нервов",
    "В 2024 году было лучше",
]
